...
RUN sed -i s/require\ \'config\'/require\ \'\\/usr\\/share\\/gratt\\/config\'/g /usr/share/gratt/gratt.rb
RUN  sed -i s/require\ \'request\'/require\ \'\\/usr\\/share\\/gratt\\/request\'/g /usr/share/gratt/gratt.rb
